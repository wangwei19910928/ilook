...
public class EmptyPanel extends Composite implements Closer {
	 ...
	 */
	public EmptyPanel(Composite parent, int style,String titleText,String labelText,Composite disposeComposite) {
		super(parent, style);
	...
	private void init(String titleText,String labelText,final Composite disposeComposite) {
